...
const INCLUDED = [
  "Хязгааргүй 360° өрөө",
  "Утаснаасаа шууд буулгах",
  "Хуваалцах холбоос + QR код",
  "Үзэлт, хүсэлтийн статистик",
  "Байрны план, видео",
  "Утасны апп (PWA)",
];
  ...
  return (
    <section id="pricing" className="border-t border-border bg-muted/40 py-24">
      <div className="container">
        ...
        {/* what's included */}
        <div className="mx-auto mt-10 max-w-3xl rounded-2xl border border-border bg-background p-7">
          <h3 className="text-sm font-medium">Бүх багцад багтсан</h3>
          <ul className="mt-4 grid gap-3 sm:grid-cols-2">
            {INCLUDED.map((item) => (
              <li key={item} className="flex items-center gap-2.5 text-sm text-muted-foreground">
                <Check className="h-4 w-4 shrink-0 text-foreground" /> {item}
              </li>
            ))}
          </ul>
          <p className="mt-6 text-xs text-muted-foreground">
            Үнэ НӨАТ багтсан. Багц дуусахад зарууд тань устахгүй — зөвхөн шинээр нийтлэх боломж хаагдана.
          </p>
        </div>
      </div>
    </section>
