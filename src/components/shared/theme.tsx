...
/** Three-way segmented control, or a single cycling button when compact. */
  ...
  if (compact) {
    ...
    return (
      <button
        ...
        className={cn(
          "grid h-9 w-9 place-items-center rounded-full border border-border text-muted-foreground transition-colors hover:text-foreground",
          className,
        )}
      >
